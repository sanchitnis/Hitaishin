...
## 1. ICF Core Coaching Competencies (International Coaching Federation)
...
| **Establishing & Maintaining Agreement** | Clarifies what the leader truly wants from each session |
| **Cultivating Trust & Safety** | Creates the psychological safety for Svadhyaya honesty |
| **Maintaining Presence** | Full attention — not managing an agenda while listening |
| **Active Listening** | Hears what's said, unsaid, and the deeper need beneath both |
...
Martin Seligman's five elements of flourishing map closely to the Five Spheres:

| PERMA Element | Description | Sphere Alignment | JP Resonance |
|---------------|-------------|-----------------|--------------|
| **P**ositive Emotions | Cultivating joy, gratitude, serenity | Sharira-Prana + Sangha | Ramdas: *Mana Kara Re Prasanna* |
| **E**ngagement | Flow states, full absorption in meaningful work | Karma Bhoomi | Nishkama Karma in action |
| **R**elationships | Quality connections, belonging | Sangha | Satsang; Guru-Shishya Parampara |
| **M**eaning | Contributing to something larger | Samaj Seva | Dharma-Sansthapana |
| **A**ccomplishment | Achievement for its own sake | Karma Bhoomi | Swami Vivekananda's Sraddha in action |

**Coaching use**: When assessing a leader's overall wellbeing, PERMA provides a rapid scan.
Which element is lowest? That is where the coaching energy belongs.

---

## 3. Character Strengths (VIA — Values in Action)
...
role doesn't activate their signature strengths. The fix: engineer toward strengths, not
compensation for weaknesses.

**Key question**: "When do you feel most alive and effective? What strengths are you using in those moments?"

---

## 4. Adaptive Leadership (Heifetz, Harvard Kennedy School)
...
- **Identify the adaptive challenge**: What values, loyalties, or losses does this require?
...
## 5. Logotherapy — Meaning-Centered Coaching (Viktor Frankl)

Frankl's core insight: The primary human drive is not pleasure (Freud) or power (Adler) but *meaning*.
When a person has a *why*, they can endure almost any *how*.

Three sources of meaning (Frankl), mapped to JP:

| Frankl's Source | Description | JP Equivalent |
|-----------------|-------------|---------------|
| **Creative work** | What you give to the world | Karma Bhoomi + Samaj Seva |
| **Experiential values** | What you receive — love, beauty, truth | Sangha + Atma |
| **Attitudinal values** | How you face unavoidable suffering | Sthitaprajna (Gita) |

**Coaching use**: When a leader is in crisis or burnout, Frankl's framework helps locate the
meaning resource they have lost contact with. It is rarely a strategy problem — it is a meaning problem.

---

## 6. Immunity to Change (Kegan & Lahey, Harvard)

Robert Kegan's framework reveals why intelligent, motivated people often fail to change despite
genuine commitment. The root: *competing commitments* — hidden assumptions that protect against loss.

**The four-column map:**
1. What do I want to change / improve?
2. What am I doing (or not doing) that prevents this?
...
## 7. Ontological Coaching (Echeverria, Flores)

The ontological approach recognizes that a person is constituted by three domains:
...
## 8. Positive Intelligence (PQ) — Shirzad Chamine
...
- **Hyper-Rational**: Over-analyzing as a way to avoid emotional engagement

**The Sage Powers** (PQ equivalents of Sthitaprajna):
- Empathize → Explore → Innovate → Navigate → Activate

**Coaching use**: When a leader is stuck in self-criticism or over-control, identify the active
Saboteur and help them access their Sage. This is the psychological vocabulary for what the Gita
calls moving from Rajasic reactivity to Sattvic response.

---

## The Integration Principle

Use frameworks in service of the person, not the framework.
